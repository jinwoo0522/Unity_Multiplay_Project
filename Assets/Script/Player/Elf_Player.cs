...
public class Elf_Player : Player
{
    ...
    void CreateState()
    {
       ...
       _stateMachine.AddTransition((ushort)ENTITY.StateType.IDLE, new StateToQSkill_Elf(this));
       _stateMachine.AddTransition((ushort)ENTITY.StateType.WALK, new StateToMouseAttack_Elf(this));
       _stateMachine.AddTransition((ushort)ENTITY.StateType.WALK, new StateToQSkill_Elf(this));
       _stateMachine.AddTransition((ushort)ENTITY.StateType.RUN, new StateToMouseAttack_Elf(this));
       _stateMachine.AddTransition((ushort)ENTITY.StateType.RUN, new StateToQSkill_Elf(this));
    }
